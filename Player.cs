public abstract class Player
{
    ...
    // computerPlayer behöver. ComputerPlayer har även en egen metod för att generera ett slumpmässigt namn från en text-fil vilket inte HumanPlayer har eller behöver.
