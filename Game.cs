public class Game
{
    ...
    private DateTime startTime; // Variabel för att lagra starttiden
    private DateTime endTime;   // Variabel för att lagra slutet av tide
...
{
    // Beräkna varaktigheten mellan start och slut
    TimeSpan gameDuration = endTime - startTime;
    string duration = gameDuration.ToString(@"mm\:ss"); // Format: minuter:sekunder
    ...
    // Lägg till den i historikhanteraren
