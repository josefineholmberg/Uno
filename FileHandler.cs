...
// FileHandler<T> är den generiska bas-klassen som definoerar abstrakta metoder för att skriva och läsa data där typen T
...
// att lägga till ytterligare fler datatyper som ska kunna hanteras på samma sätt i framtiden. 
